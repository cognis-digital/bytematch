#!/usr/bin/env sh
# Universal installer for bytematch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/bytematch.git"
echo "Installing bytematch ..."
